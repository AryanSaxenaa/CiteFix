...
export function buildDocGenValues(job: AnalysisJob): Record<string, unknown> {
  ...
  return {
    // Header
    ReportTitle: "Scoutlytics Implementation Brief",
    ...
    ChecklistItems: [
      ...
      { Item: "Re-run Scoutlytics analysis to verify improvement" },
    ],

    // Footer
    FooterText: "Generated by Scoutlytics — Powered by You.com APIs & Foxit PDF | DeveloperWeek 2026",
  };
}
